...
{
   public class RecomendBookViewModel:ViewModelBase
    {
        RecomendViewModel boss_page;
        Book selected_book;
        public RecomendBookViewModel(Book obj1, RecomendViewModel obj2)
        {
            selected_book = obj1;
            boss_page = obj2;
        ...
        private void Back()
        {
            Page Books_page = new RecomendBooks(boss_page);
